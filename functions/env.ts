export const GITHUB_OAUTH_LOGIN_ENDPOINT =
  "https://github.com/login/oauth/access_token";
export const GITHUB_OAUTH_AUTHORIZE_ENDPOINT =
  "https://github.com/login/oauth/authorize";
export const GITHUB_USER_ENDPOINT = "https://api.github.com/user";
export const ELM_PACKAGE_SEARCH_ENDPOINT =
...
export const NODE_ENV: undefined | string = process.env.NODE_ENV;
